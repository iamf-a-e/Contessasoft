...
def agent_response(prompt, user_data, phone_id):
    ...
    try:
        # Check for special agent commands first
        if prompt == "agent_accept":
        ...
        # Rest of your agent chat handling...
        # ... [keep your existing message forwarding logic]
