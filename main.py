...
action_mapping = {
    ...
    "waiting_for_human_agent_response": handle_waiting_for_human_agent_response,
    "talking_to_human_agent": handle_waiting_for_human_agent_response, 
    "human_agent_followup": human_agent_followup,    
    "agent_reply": handle_agent_reply,
    "agent_conversation": handle_agent_conversation,
    "agent_available": handle_agent_available,        
    "agent_message": handle_agent_message,
    "customer_message_during_agent_chat": handle_customer_message_during_agent_chat,
